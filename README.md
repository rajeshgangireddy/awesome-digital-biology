...
| **Ensemble-Conditioned Molecular Design** — 3D molecular generation from conformational ensembles | [paper](https://arxiv.org/abs/2609.15077) · [code](https://github.com/rssrwn/ensemble-cond-design) ![Stars](https://img.shields.io/github/stars/rssrwn/ensemble-cond-design?style=social) · [dataset](https://zenodo.org/records/22485204) | 2026 | Irwin et al. · collaborators | Molecular generation conditioned on conformational ensembles, shapes, pharmacophores, and protein pockets; arXiv preprint with public data and checkpoint |
...
| **ScienceBuddy** — Interactive scientific workspace and recursive self-improvement agent | [paper](https://arxiv.org/abs/2609.17523) · [code](https://github.com/Gen-Verse/ScienceBuddy) ![Stars](https://img.shields.io/github/stars/Gen-Verse/ScienceBuddy?style=social) | 2026 | Xue et al. · Gen-Verse | Scientific workspace with execution records, tool inspection, and biomedical research workflows; arXiv preprint |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **OpenDiscoveryTrace** — Process-trace dataset and benchmark for AI-scientist workflows | [paper](https://arxiv.org/abs/2609.09203) · [code](https://github.com/aayambansal/OpenDiscoveryTrace) ![Stars](https://img.shields.io/github/stars/aayambansal/OpenDiscoveryTrace?style=social) · [dataset](https://huggingface.co/datasets/aayambansall/OpenDiscoveryTrace) | 2026 | Bansal & Balaji | Public process traces for evaluating scientific-discovery agents; arXiv preprint with code and dataset release |
