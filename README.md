...
| **Tahoe-x1** — Perturbation-response foundation model for single-cell biology | [project](https://www.tahoebio.ai/) · [code](https://github.com/tahoebio/tahoe-x1) ![Stars](https://img.shields.io/github/stars/tahoebio/tahoe-x1?style=social) | 2025 | Tahoe Therapeutics & collaborators | Single-cell foundation model trained on large-scale perturbation data for cellular-response prediction and virtual-cell applications |
...
| **GeneCompass** — Knowledge-informed single-cell foundation model | [code](https://github.com/xCompass-AI/GeneCompass) ![Stars](https://img.shields.io/github/stars/xCompass-AI/GeneCompass?style=social) | 2024 | Yang et al. · Compass-AI collaborators | Uses biological knowledge graphs and gene-expression context for single-cell representation learning and perturbation-related tasks |
...
| **Universal Cell Embeddings (UCE)** — Zero-shot foundation model for single-cell data | [code](https://github.com/snap-stanford/UCE) ![Stars](https://img.shields.io/github/stars/snap-stanford/UCE?style=social) | 2023 | Rosen et al. · Stanford University | Species- and tissue-agnostic cell embeddings from gene-expression profiles without task-specific fine-tuning |
| **scFoundation / xTrimoGene** — Large-scale single-cell representation learning | [paper](https://arxiv.org/abs/2311.15156) · [code](https://github.com/biomap-research/scFoundation) ![Stars](https://img.shields.io/github/stars/biomap-research/scFoundation?style=social) | 2023 | Hao et al. · BioMap & collaborators | Large pretrained models for single-cell gene-expression representation, imputation, perturbation, and downstream analysis |
| **CellPLM** — Pretrained cell language model | [code](https://github.com/OmicsML/CellPLM) ![Stars](https://img.shields.io/github/stars/OmicsML/CellPLM?style=social) | 2023 | Wen et al. · OmicsML | Cell-level pretraining for cell-type annotation, perturbation prediction, and cross-dataset transfer |
