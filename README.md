...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **QALPA** — Property-guided diffusion for flexible-molecule design | [paper](https://arxiv.org/abs/2609.16527) · [code](https://github.com/lmedranos/qalpa) ![Stars](https://img.shields.io/github/stars/lmedranos/qalpa?style=social) | 2026 | Hanna et al. | arXiv; active learning couples diffusion-based generation to quantum-mechanical feedback for property-space exploration |
| **ShEPhERD-2** — Interaction-profile-conditioned generative molecular design | [paper](https://doi.org/10.64898/2026.09.10.750648) · [code](https://github.com/coleygroup/shepherd2) ![Stars](https://img.shields.io/github/stars/coleygroup/shepherd2?style=social) · [model](https://huggingface.co/kabeywar/shepherd2) | 2026 | Abeywardane et al. · Massachusetts Institute of Technology | bioRxiv; 3D generation conditioned on shape, electrostatics, and pharmacophores |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **HyCoSeq** — Contextual hyperbolic representation learning for genomic sequences | [paper](https://arxiv.org/abs/2609.16925) · [code](https://github.com/zchhh01/Hycoseq) ![Stars](https://img.shields.io/github/stars/zchhh01/Hycoseq?style=social) | 2026 | Zeng et al. | arXiv; multi-curvature Lorentz representations with contextual residual aggregation for genomic sequence modeling |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **WetRobo** — Reproducible robot kit for coding agents in biological laboratories | [paper](https://arxiv.org/abs/2609.18435) · [code](https://github.com/tsudalab/WetRobo) ![Stars](https://img.shields.io/github/stars/tsudalab/WetRobo?style=social) | 2026 | Oikawa et al. · Tsuda Lab | arXiv; open robot environment with demonstrations, safety layer, camera streaming, and reproducible lab-task trials |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **BioPhys-Bridge** — Physics-grounded benchmark for biological mechanism reasoning | [paper](https://arxiv.org/abs/2609.19180) · [code](https://github.com/qyxu1994/BioPhys-Bridge) ![Stars](https://img.shields.io/github/stars/qyxu1994/BioPhys-Bridge?style=social) · [dataset](https://huggingface.co/datasets/qyxu1994/BioPhys-Bridge) | 2026 | Xu · BioPhys-Bridge | arXiv; 500-case dataset linking quantitative biophysical evidence, mechanisms, and agent-facing scientific decisions |
