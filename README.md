...
| **Rosetta Foundry** — Infrastructure for protein design models | [project](https://rosettacommons.github.io/foundry/) · [code](https://github.com/RosettaCommons/foundry) ![Stars](https://img.shields.io/github/stars/RosettaCommons/foundry?style=social) | 2025 | Rosetta Commons · Institute for Protein Design | Shared training and inference tooling for RFD3, RF3, ProteinMPNN, and LigandMPNN |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **BindCraft2 (BC2)** — Configurable protein binder design workflow | [code](https://github.com/PacesaLab/BindCraft2) ![Stars](https://img.shields.io/github/stars/PacesaLab/BindCraft2?style=social) · [release](https://github.com/PacesaLab/BindCraft2/releases/tag/v1.0.0) | 2026 | Pacesa Lab | De novo miniprotein, scaffolded binder, cyclic-peptide, and multistate design with AlphaFold and ProteinMPNN-based evaluation |
...
| **PaperQA2** — Retrieval-augmented scientific literature agent | [paper](https://arxiv.org/abs/2409.13740) · [code](https://github.com/Future-House/paper-qa) ![Stars](https://img.shields.io/github/stars/Future-House/paper-qa?style=social) · [project](https://futurehouse.gitbook.io/futurehouse-cookbook) | 2024 | Skarlinski et al. · FutureHouse | Citation-grounded question answering, summarization, and contradiction detection over scientific documents |
