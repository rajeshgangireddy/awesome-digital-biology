...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **ESMFold2** — Single-sequence all-atom protein structure prediction | [paper](https://www.biorxiv.org/content/10.64898/2026.06.03.729735) · [code](https://github.com/Biohub/esm) ![Stars](https://img.shields.io/github/stars/Biohub/esm?style=social) · [model](https://huggingface.co/biohub/ESMFold2) | 2026 | Biohub | ESMC-based diffusion predictor for fast single-sequence all-atom structure prediction; MIT release with Biohub acceptable-use terms |
| **Protenix** — Open AlphaFold 3 reproduction | [paper](https://www.biorxiv.org/content/10.64898/2026.02.05.703733) · [code](https://github.com/bytedance/Protenix) ![Stars](https://img.shields.io/github/stars/bytedance/Protenix?style=social) | 2026 | ByteDance | Open protein, nucleic-acid, ligand, and RNA-MSA structure-prediction pipeline; Protenix-v1 code and weights are Apache-2.0, while v2 weights are proprietary |
...
| **Chai-1** — Multimodal biomolecular interaction prediction | [paper](https://www.biorxiv.org/content/10.1101/2024.10.10.615955) · [code](https://github.com/chaidiscovery/chai-lab) ![Stars](https://img.shields.io/github/stars/chaidiscovery/chai-lab?style=social) | 2024 | Chai Discovery | Open multimodal structure prediction for proteins, nucleic acids, ligands, glycans, covalent bonds, templates, and restraints; Apache-2.0 |
| **RoseTTAFold All-Atom** — Generalized all-atom biomolecular modeling | [paper](https://doi.org/10.1126/science.adl2528) · [code](https://github.com/baker-laboratory/RoseTTAFold-All-Atom) ![Stars](https://img.shields.io/github/stars/baker-laboratory/RoseTTAFold-All-Atom?style=social) | 2024 | Krishna et al. · Baker Lab | Science; predicts protein, nucleic-acid, ligand, metal, and covalent-modification complexes; repository and dependency licensing must be checked separately |
...
| **Mechanistic Interpretability of Fine-Tuned Protein Language Models for Nanobody Thermostability Prediction** | [paper](https://doi.org/10.1093/bioinformatics/btag685) · [code](https://github.com/matsunagalab/paper_nanobody-thermostability-sae) ![Stars](https://img.shields.io/github/stars/matsunagalab/paper_nanobody-thermostability-sae?style=social) · [data](https://doi.org/10.5281/zenodo.18012027) | 2026 | Murakami et al. · Saitama University, Epsilon Molecular Engineering & RIKEN | Bioinformatics; fine-tunes ESM-2 for VHH thermostability and uses sparse autoencoders to derive interpretable residue-level hypotheses |
...
| **Chai-2** — Experimental protein binder design model | [project](https://www.chaidiscovery.com/blog/chai-2) | 2025 | Chai Discovery | Protein binder design system from the Chai team; include as a major result while noting that a complete public implementation and weights are not yet available |
| **PXDesign** — Protein binder design with geometric deep learning | [code](https://github.com/luost26/PXDesign) ![Stars](https://img.shields.io/github/stars/luost26/PXDesign?style=social) | 2025 | Luo et al. · University of Washington & collaborators | Open binder-design pipeline combining target-conditioned generation and sequence design; Apache-2.0 repository with separately licensed model/tool dependencies |
...
| **AntiFold** — Sequence design for antibody variable regions | [code](https://github.com/oxpig/AntiFold) ![Stars](https://img.shields.io/github/stars/oxpig/AntiFold?style=social) | 2023 | Hummer et al. · Oxford Protein Informatics Group | Antibody-focused protein language model for designing variable-region sequences while preserving structural and functional constraints |
...
| **Boltz-2** — Biomolecular structure and binding-affinity prediction | [paper](https://www.biorxiv.org/content/10.1101/2025.06.14.659707) · [code](https://github.com/jwohlwend/boltz) ![Stars](https://img.shields.io/github/stars/jwohlwend/boltz?style=social) | 2025 | Wohlwend et al. · MIT & collaborators | Boltz-1 successor jointly predicting complex structures and ligand-binding affinity; MIT code and weights, with training/evaluation release still evolving |
| **DiffDock-L** — Diffusion-based molecular docking | [paper](https://arxiv.org/abs/2210.01776) · [code](https://github.com/gcorso/DiffDock) ![Stars](https://img.shields.io/github/stars/gcorso/DiffDock?style=social) | 2025 | Corso et al. · MIT & collaborators | Large-scale DiffDock model family for protein–ligand pose generation and confidence estimation; use the official repository for released checkpoints and inference |
| **PocketFlow** — Protein pocket generation with prior-informed flow matching | [paper](https://arxiv.org/abs/2409.19520) · [code](https://github.com/zaixizhang/PocketFlow) ![Stars](https://img.shields.io/github/stars/zaixizhang/PocketFlow?style=social) | 2024 | Zhang et al. · Tsinghua University & collaborators | NeurIPS; generates protein pockets with prior-informed flow matching for structure-based molecular design |
| **MolCRAFT** — Structure-based 3D molecular generation | [paper](https://arxiv.org/abs/2404.12141) · [code](https://github.com/GenSI-THUAIR/MolCRAFT) ![Stars](https://img.shields.io/github/stars/GenSI-THUAIR/MolCRAFT?style=social) | 2024 | GenSI-THUAIR | 3D molecular generation conditioned on protein pockets; released implementation and checkpoints; check repository terms before commercial use |
| **Uni-Mol2** — Universal 3D molecular representation learning | [paper](https://arxiv.org/abs/2405.11769) · [code](https://github.com/deepmodeling/Uni-Mol) ![Stars](https://img.shields.io/github/stars/deepmodeling/Uni-Mol?style=social) | 2024 | Zhou et al. · DP Technology | Scalable 3D molecular foundation model for property prediction, conformation, and structure-based drug-discovery tasks |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **VirPLM** — Antigenic prediction of influenza A/H3N2 viruses with a fine-tuned protein language model | [paper](https://doi.org/10.1093/bioinformatics/btag692) · [code](https://github.com/xingyili/VirPLM) ![Stars](https://img.shields.io/github/stars/xingyili/VirPLM?style=social) · [release](https://doi.org/10.5281/zenodo.21650323) | 2026 | Li et al. · Northwestern Polytechnical University | Bioinformatics; adapts ESM-2 to H3N2 HA1 sequences for antigenic prediction, with cross-validation and retrospective time-split evaluation |
| **Functional alignment of protein language models via reinforcement learning** | [paper](https://doi.org/10.1038/s41467-026-77557-2) | 2026 | Blalock et al. · Duke University & University of Wisconsin-Madison | Nature Communications paper on using reinforcement learning to align protein language models with functional objectives |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **Efficient MoE Training for Biological Foundation Models** — BioNeMo Mixtral training recipe | [code](https://github.com/NVIDIA-BioNeMo/bionemo-recipes/tree/main/recipes/mixtral_native_te) ![Stars](https://img.shields.io/github/stars/NVIDIA-BioNeMo/bionemo-recipes?style=social) · [announcement](https://developer.nvidia.com/blog/efficient-moe-training-for-biological-foundation-models/) | 2026 | Horton · NVIDIA BioNeMo | NVIDIA Technical Blog tutorial and recipe for Transformer Engine MoE training with expert parallelism, FSDP2, and MXFP8 |
| **DeepEffector** — Protein language model-driven effector prediction in fungi and oomycetes | [paper](https://doi.org/10.1093/plphys/kiag691) · [project](https://deepeffector.hainanu.edu.cn/) | 2026 | Li et al. · Hainan University | Plant Physiology paper and web server combining protein-language-model embeddings with a hybrid attention/CNN predictor |
