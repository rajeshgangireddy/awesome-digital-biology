...
| **DNA-Diffusion** — Diffusion model for synthetic regulatory DNA | [code](https://github.com/pinellolab/DNA-Diffusion) ![Stars](https://img.shields.io/github/stars/pinellolab/DNA-Diffusion?style=social) · [model](https://huggingface.co/ssenan/DNA-Diffusion) | 2025 | Pinello Lab | Generates 200-bp cell-type-specific regulatory elements; includes training/data-curation code, notebooks, and a Hugging Face checkpoint |
...
| **ProtNote** — Text-guided protein-function prediction | [paper](https://doi.org/10.1093/bioinformatics/btaf170) · [code](https://github.com/microsoft/protnote) ![Stars](https://img.shields.io/github/stars/microsoft/protnote?style=social) | 2025 | Char et al. · Microsoft | Multimodal protein-language model that uses free-form text for supervised and zero-shot function prediction; MIT code and reproducibility data |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **Scientific Agent Skills** — Procedural knowledge library for research agents | [paper](https://arxiv.org/abs/2609.00065) · [code](https://github.com/K-Dense-AI/scientific-agent-skills) ![Stars](https://img.shields.io/github/stars/K-Dense-AI/scientific-agent-skills?style=social) | 2026 | Kassis et al. · K-Dense AI | Open Agent Skills library spanning genomics, cheminformatics, biomedical analysis, and scientific communication; the paper reports corpus measurements and no task-level evaluation |
...
| **SpatialAgent** — Autonomous agent for spatial biology | [paper](https://www.biorxiv.org/content/10.1101/2025.04.03.646459v1) · [code](https://github.com/Genentech/SpatialAgent) ![Stars](https://img.shields.io/github/stars/Genentech/SpatialAgent?style=social) | 2025 | Wang et al. · Genentech & collaborators | Plan-act-conclude agent with 72 tools and 17 skill templates for spatial transcriptomics, single-cell RNA-seq, and molecular-biology workflows |
...
| Project / work | Links | Year | Authors / organization | Notes |
|---|---|---:|---|---|
| **BioMCP** — Biomedical CLI and Model Context Protocol server | [code](https://github.com/genomoncology/biomcp) ![Stars](https://img.shields.io/github/stars/genomoncology/biomcp?style=social) · [project](https://biomcp.org/) | 2026 | GenomOncology | Unified command surface and MCP server for literature, genes, variants, trials, drugs, diseases, pathways, proteins, and local study analytics; v0.9.0 released September 2026 |
